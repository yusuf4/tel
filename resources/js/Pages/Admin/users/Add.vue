...
export default {
    name: "Add",
    layout: Layout,
    components: {Link, VueMultiselect, Head},
    data() {
        return {
            value: null,
            dipinput: false,
    ...
    <div class="pt-4 px-2">
        <div class="my-2 pb-12">
            <span class="relative flex justify-center">
                  ...
                  <span class="relative z-10 bg-gray-50 px-6">Иловаи корманд</span>
            </span>
        </div>
        <!-- Intixob buttons -->
        ...
        <!-- Form -->
        <form class="pt-4" @submit.prevent="formValues.post(route('user.store'))">
            ...
            <div class="flex justify-start mt-8">
                <div class="px-4 w-1/2">
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-5 group">
                            ...
                            <div v-if="errors.name" class="text-xs mt-1 text-red-600">{{errors.name}}</div>
                        </div>
                        <div class="relative z-0 w-full mb-5 group">
                            <input
                        ...
                        <div
                            v-show="formValues.dastgoh==='1' ? shoxis===false : shoxis===true"
                        ...
                        <div
                            v-show="formValues.dastgoh==='1' ? utoq===false : utoq===true"
                            class="relative z-0 w-full mb-5 group">
                            <input
                ...
                <div class="w-1/2">
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div
                            v-if="formValues.dastgoh==='3' ? doxili=false : doxili=true"
                    ...
                    <div
                        ...
                        class="my-8 flex flex-col justify-end items-end">
                        <VueMultiselect
                    ...
                    <div class="flex justify-end mt-12">
                        ...
                        <button
                            ...
                            class="text-white bg-blue-700 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Илова
                        </button>
                    </div>
                </div>
