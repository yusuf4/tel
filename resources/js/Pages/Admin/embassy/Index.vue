...
export default {
    ...
    watch:{
        search(value){
            Inertia.get('/emb/lists', {search: value}, {
                preserveState: true
            });
        },
    }
...
<template>
    ...
    <div class="py-2 mb-8">
            <span class="relative flex justify-center">
                  ...
                  <span class="relative z-10 bg-gray-50 px-6">Намояндагиҳои дипломатии Тоҷикистон дар хориҷа</span>
            </span>
    </div>
    <div>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tr
                    ...
                    <td class="px-6 py-4 text-right flex items-center justify-end">
                        ...
                        <Link
                            onclick="return confirm('Шумо дар ҳақиқат мехоҳед ин Намояндагиро нест намоед?')"
                            method="delete"
                            as="button"
                            type="button"
                            :href="route('emb.delete', item.id)"
