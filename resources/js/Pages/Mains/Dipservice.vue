...
export default {
    ...
    watch:{
        search(value){
            Inertia.get('/main/dipservice', {search: value}, {
                preserveState: true
            });
        },
        dipservice(value){
            Inertia.get('/main/dipservice', {dipservice: value}, {
                preserveState: true
            });
        },
    }
...
<template>
    <div class="text-4xl text-white font-semibold mt-8">
        <p class="text-center text-xl mb-12">КВД Дипсервис</p>
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div class="flex justify-between items-center pb-4 mx-1 dark:bg-gray-900 flex justify-end items-center">
                <!-- <div
                     class=""
                 >
            ...
            <table class="w-full text-sm text-left rtl:text-right dark:text-gray-400">
                ...
                <tr
                    ...
                    <td class="px-6 py-4 text-right flex items-center justify-end">
                        <Link
                            :href="route('dipservice.user', item.id)"
